...
public class SplashWindow extends Window {
     ...
     private Font theMainFont = new Font("SansSerif", Font.BOLD, 14);
    /**
    ...
    public void paint(Graphics g) {
        ...
        g.drawString("Version:", 80, 210);       
        g.drawString("0.31", 150, 210);
        g.drawString("Author:", 80, 230);       
        g.drawString("Damien Farrell", 150, 230);
        g.drawString("Copyright:", 80, 250);       
        g.drawString("2004-", 160, 250);        
